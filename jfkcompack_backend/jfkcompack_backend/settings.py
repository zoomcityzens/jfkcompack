"""
Django settings for jfkcompack_backend project.
...
ROOT_URLCONF = 'jfkcompack_backend.urls'
...
WSGI_APPLICATION = 'jfkcompack_backend.wsgi.application'
